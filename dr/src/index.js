...
app.get("/chushmaproject",(req,res)=>{
    res.render("chushmaproject")
})

app.get("/chushmaproject1",(req,res)=>{
    res.render("chushmaproject1")
})

app.get("/chushmaproject2",(req,res)=>{
    res.render("chushmaproject2")
})
